...
import { applyEncryptionMiddleware } from '@/lib/encryption/prisma-middleware';
...
export const prisma =
  ...
  new PrismaClient({
    ...
    datasources: {
      db: {
        url: process.env.POSTGRES_PRISMA_URL || process.env.DATABASE_URL // Uses connection pooling
      }
    }
  });
